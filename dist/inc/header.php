...
<head>
  ...
  <title>Horizon | <?php echo $page; ?></title>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="main-nav-links">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="propterties.php" class="nav-link">Properties</a></li>
          <li class="nav-item active"><a href="builders.php" class="nav-link">Builders</a></li>
          <li class="nav-item active"><a href="services.php" class="nav-link">Services</a></li>
          <li class="nav-item active"><a href="listing.php" class="nav-link">Listing</a></li>
